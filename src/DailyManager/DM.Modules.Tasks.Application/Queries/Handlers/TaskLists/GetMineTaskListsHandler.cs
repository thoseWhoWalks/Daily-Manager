...
{
    internal class GetMineTaskListsHandler 
        : IQueryHandler<GetMineTaskLists, IEnumerable<TaskListListItemModel>>
    {
        #region Dependencies
        ...
        public GetMineTaskListsHandler(
        ...
        public IEnumerable<TaskListListItemModel>? Handle(GetMineTaskLists query)
        {
        ...
        public async Task<IEnumerable<TaskListListItemModel>?> HandleAsync(GetMineTaskLists query)
        {
